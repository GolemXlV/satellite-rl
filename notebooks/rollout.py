...
# from satellite_gym.envs.satellite_env import SatelliteEnvV0, SatelliteEnv
...
# env_v0 = SatelliteEnvV0(df)
# register_env("SatelliteEnv-v0", lambda x: env_v0)

# # sat_id = randint(0, SATELLITES_NUM)
# sat_id = 41

# env_v1 = SatelliteEnv(df, sat_id=sat_id)
# register_env("SatelliteEnv-v1", lambda x: env_v1)
